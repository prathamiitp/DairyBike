...
function [x_1,x_2] = find_equilibrium_points(x1_dot, x2_dot)
  ...
  [x_1, x_2] = solve(x2_dot == 0,x1_dot == 0);
  x_1([3,2])=x_1([2,3]);
  x_2([3,2])=x_2([2,3]);
...
function jacobian_matrices = find_jacobian_matrices(x_1, x_2, x1_dot, x2_dot)
  ...
  temp1 = subs(temp, {x1 , x2}, {solutions(1,1),solutions(1,2)});
  temp2 = subs(temp, {x1 , x2}, {solutions(2,1),solutions(2,2)});
  temp3 = subs(temp, {x1 , x2}, {solutions(3,1),solutions(3,2)});
  jacobian_matrices = {double(temp1),double(temp2),double(temp3)};
